class LocustRaam extends UTPawn
	placeable;
...
DefaultProperties
{
    ...
    SkeletalMesh=SkeletalMesh'UT3_Model_Locust_Raam.UT3_Model_Locust_Raam'
    ...
    CurrCharClassInfo=class'UTGame.UTFamilyInfo_GOW_Locust_Raam'
