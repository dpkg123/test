...
defaultproperties 
{
  defaultMesh=SkeletalMesh'UT3_Model_Gus.UT3_Model_Gus'
...
CurrCharClassInfo=class'UTGame.UTFamilyInfo_GOW_Gus'
SoundGroupClass=class'UTGame.UTPawnSoundGroup_Gus'
