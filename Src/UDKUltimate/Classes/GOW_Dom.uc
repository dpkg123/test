...
defaultproperties 
{
  defaultMesh=SkeletalMesh'UT3_Model_Dom.UT3_Model_Dom'
...
CurrCharClassInfo=class'UTGame.UTFamilyInfo_GOW_Dom'
SoundGroupClass=class'UTGame.UTPawnSoundGroup_Dom'
