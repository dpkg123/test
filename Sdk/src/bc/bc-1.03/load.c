...
static const char SSIRCSid[]="$Header: //depot/InterixBSD/src/bc/bc-1.03/load.c#1 2004/09/23 05:45:17 FAREAST\\ranas $";
...
addbyte (int byte) {
  ...
  /* Store the byte. */
  functions[func].f_body[seg][offset] = (char)byte;
