...
static const char SSIRCSid[]="$Header: //depot/InterixBSD/src/bc/bc-1.03/main.c#1 2004/09/23 05:45:17 FAREAST\\ranas $";
  ...
  if (use_math && first_file)
    {
      ...
      /* char *bc_math_file = _prefixInstallPath(BC_MATH_FILE, 0, 0); */
	...
	{
	  fprintf (stderr, "Math Library %s unavailable.\n", bc_math_file);
	  exit (1);
	}
#else
