...
static const char SSIRCSid[]="$Header: //depot/InterixBSD/src/bc/bc-1.03/util.c#1 2004/09/23 05:45:17 FAREAST\\ranas $";
     ...
     int  namekind;
{
  ...
  if (strlen(name) != 1)
    bc_warn ("multiple letter name - %s", name);
