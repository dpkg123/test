...
struct change
{
  ...
  ssize_t inserted;			/* # lines of file 1 changed here.  */
  ssize_t deleted;			/* # lines of file 0 changed here.  */
  ssize_t line0;			/* Line number of 1st deleted line.  */
  ssize_t line1;			/* Line number of 1st inserted line.  */
...
struct file_data {
    ...
    ssize_t linbuf_base, buffered_lines, valid_lines, alloc_lines;
...
ssize_t translate_line_number PARAMS((struct file_data const *, ssize_t));
struct change *find_change PARAMS((struct change *));
struct change *find_reverse_change PARAMS((struct change *));
void analyze_hunk PARAMS((struct change *, ssize_t *, ssize_t  *, ssize_t *, ssize_t *, ssize_t *, ssize_t));
...
void print_number_range PARAMS((int, struct file_data *, ssize_t, ssize_t));
...
void translate_range PARAMS((struct file_data const *, ssize_t, ssize_t, ssize_t *, ssize_t *));
