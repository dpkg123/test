...
static const char SSIRCSid[]="$Header: /E/interix/src/diff/diffutils-2.7/side.c,v 2.1 1996/03/01 01:53:38 OpenNTBuilder Exp $";
...
static void print_sdiff_common_lines PARAMS((ssize_t, ssize_t));
static void print_sdiff_hunk PARAMS((struct change *));

/* Next line number to be printed in the two input files.  */
static ssize_t next0, next1;
...
print_sdiff_common_lines (limit0, limit1)
     ssize_t limit0, limit1;
{
  ssize_t i0 = next0, i1 = next1;
