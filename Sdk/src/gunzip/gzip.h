...
#ifdef __INTERIX
extern int as_pack;         /* running as the "pack" utility. */
extern int show_pack_stats; /* print out stats after each file is packed. */
extern ulg byte_count[];    /* keeps a count of the frequency of each byte */
#endif /* __INTERIX */
